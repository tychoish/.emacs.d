...
(keymap-set hud-mode-map "C-c t" hud-core-map)
(keymap-set hud-core-map "b" hud-blogging-map)
(keymap-set hud-core-map "t" hud-theme-map)
(keymap-set hud-mode-map "C-c f" hud-display-map)
(keymap-set hud-display-map "o" hud-display-opacity-map)
(keymap-set hud-mode-map "C-c k" hud-kill-map)
(keymap-set hud-mode-map "C-c w" hud-web-browser-map)
(keymap-set hud-mode-map "C-c g" hud-ecclectic-grep-map)
(keymap-set hud-ecclectic-grep-map "p" '(hud-ecclectic-grep-project-map . "project-grep"))
(keymap-set hud-ecclectic-grep-map "r" '(hud-ecclectic-rg-map . "+ripgrep"))
(keymap-set hud-ecclectic-grep-map "s" hud-consult-search-map)
(keymap-set hud-mode-map "C-c ." hud-completion-map)
(keymap-set hud-mode-map "C-c l" hud-ide-map)
(keymap-set hud-ide-map "l" hud-eglot-global-map)
(keymap-set hud-mode-map "C-c h" hud-docs-map)
(keymap-set hud-mode-map "C-x C-b" hud-buffer-control-map)
(keymap-set hud-mode-map "C-c s" hud-shell-map)
(keymap-set hud-shell-map "e" hud-shell-eat-map)
(keymap-set hud-mode-map "C-c r" hud-robot-map)
(keymap-set hud-robot-map "s" hud-robot-agent-shell-map)
(keymap-set hud-robot-map "g" hud-robot-gptel-map)
(keymap-set hud-robot-gptel-map "m" hud-robot-gptel-set-default-model-map)

(keymap-set hud-mode-map "C-c q" hud-anzu-map)
(keymap-set hud-mode-map "C-x g" hud-magit-map)
(keymap-set hud-mode-map "C-x d" hud-docker-map)

(keymap-set hud-mode-map "C-c o" orgx-global-map)
(keymap-set orgx-global-map "l" orgx-link-map)
(keymap-set hud-mode-map "C-c m" hud-mail-map)

(keymap-set hud-mode-map "C-c d" hud-denote-map)
(keymap-set hud-denote-map "o" hud-denote-org-map)
(keymap-set hud-denote-map "s" hud-denote-sequence-map)
(keymap-set hud-denote-map "e" hud-denote-explore-map)
(keymap-set hud-denote-map "c" hud-denote-review-map)

(keymap-set hud-mode-map "C-c C-;" hud-consult-mode-map)
(keymap-set hud-magit-map "m" hud-smerge-map)
...
(keymap-set hud-mode-map "C-c h h" #'help)
...
(keymap-set hud-mode-map "C-c h a" #'mark-whole-buffer)
